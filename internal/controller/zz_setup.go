...
import (
	...
	accesspolicyiambinding "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/accesscontextmanager/accesspolicyiambinding"
	accesspolicyiammember "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/accesscontextmanager/accesspolicyiammember"
	accesspolicyiampolicy "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/accesscontextmanager/accesspolicyiampolicy"
	...
	endpointattachment "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/apigee/endpointattachment"
	...
	environmentiambinding "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/apigee/environmentiambinding"
	environmentiammember "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/apigee/environmentiammember"
	environmentiampolicy "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/apigee/environmentiampolicy"
	...
	key "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/apikeys/key"
	...
	reservationassignment "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/bigquery/reservationassignment"
	...
	workerpool "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/cloudbuild/workerpool"
	...
	awscluster "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/container/awscluster"
	awsnodepool "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/container/awsnodepool"
	azureclient "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/container/azureclient"
	azurecluster "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/container/azurecluster"
	azurenodepool "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/container/azurenodepool"
	...
	instancedatafusion "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/datafusion/instance"
	...
	serviceconsumersiambinding "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/endpoints/serviceconsumersiambinding"
	serviceconsumersiammember "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/endpoints/serviceconsumersiammember"
	serviceconsumersiampolicy "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/endpoints/serviceconsumersiampolicy"
	...
	release "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/firebaserules/release"
	ruleset "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/firebaserules/ruleset"
	...
	logview "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/logging/logview"
	...
	connectivityhub "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/network/connectivityhub"
	connectivityspoke "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/network/connectivityspoke"
	...
	runtime "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/notebooks/runtime"
	runtimeiambinding "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/notebooks/runtimeiambinding"
	runtimeiammember "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/notebooks/runtimeiammember"
	runtimeiampolicy "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/notebooks/runtimeiampolicy"
	policyorgpolicy "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/orgpolicy/policy"
	ospolicyassignment "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/osconfig/ospolicyassignment"
	...
	certificatetemplateiambinding "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/privateca/certificatetemplateiambinding"
	certificatetemplateiammember "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/privateca/certificatetemplateiammember"
	certificatetemplateiampolicy "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/privateca/certificatetemplateiampolicy"
	...
	enterprisekey "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/recaptcha/enterprisekey"
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	for _, setup := range []func(ctrl.Manager, controller.Options) error{
		...
		serviceconsumersiambinding.Setup,
		serviceconsumersiammember.Setup,
		serviceconsumersiampolicy.Setup,
		...
		connectivityhub.Setup,
		connectivityspoke.Setup,
		...
		location.Setup,
		runtime.Setup,
		runtimeiambinding.Setup,
		runtimeiammember.Setup,
		runtimeiampolicy.Setup,
		...
		certificatetemplateiambinding.Setup,
		certificatetemplateiammember.Setup,
		certificatetemplateiampolicy.Setup,
