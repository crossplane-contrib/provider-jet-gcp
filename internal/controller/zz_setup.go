...
import (
	...
	gcpolicy "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/bigtable/gcpolicy"
	...
	analysisnote "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/container/analysisnote"
	analysisoccurrence "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/container/analysisoccurrence"
	...
	cxagent "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/dialogflow/cxagent"
	cxentitytype "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/dialogflow/cxentitytype"
	cxenvironment "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/dialogflow/cxenvironment"
	cxflow "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/dialogflow/cxflow"
	cxintent "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/dialogflow/cxintent"
	cxpage "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/dialogflow/cxpage"
	cxversion "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/dialogflow/cxversion"
	...
	configpatchdeployment "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/os/configpatchdeployment"
	loginsshpublickey "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/os/loginsshpublickey"
	...
	transferjob "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/storage/transferjob"
	...
	aidataset "github.com/crossplane-contrib/provider-jet-gcp/internal/controller/vertex/aidataset"
...
func Setup(mgr ctrl.Manager, l logging.Logger, wl workqueue.RateLimiter, ps terraform.SetupFn, ws *terraform.WorkspaceStore, cfg *tjconfig.Provider, concurrency int) error {
	for _, setup := range []func(ctrl.Manager, logging.Logger, workqueue.RateLimiter, terraform.SetupFn, *terraform.WorkspaceStore, *tjconfig.Provider, int) error{
		...
		configpatchdeployment.Setup,
		loginsshpublickey.Setup,
		capool.Setup,
