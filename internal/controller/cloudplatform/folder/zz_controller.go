...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	name := managed.ControllerName(v1alpha2.Folder_GroupVersionKind.String())
	...
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha2.Folder_GroupVersionKind),
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["google_folder"])),
