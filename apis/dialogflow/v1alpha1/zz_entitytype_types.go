...
type EntityTypeEntitiesObservation struct {
}

type EntityTypeEntitiesParameters struct {
...
type EntityTypeParameters struct {
	...
	// +kubebuilder:validation:Optional
	Entities []EntityTypeEntitiesParameters `json:"entities,omitempty" tf:"entities,omitempty"`
