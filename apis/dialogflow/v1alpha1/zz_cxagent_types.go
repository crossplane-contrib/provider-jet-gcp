...
// CxAgentSpec defines the desired state of CxAgent
type CxAgentSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CxAgentParameters `json:"forProvider"`
}

// CxAgentStatus defines the observed state of CxAgent.
type CxAgentStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CxAgentObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// CxAgent is the Schema for the CxAgents API
...
type CxAgent struct {
	...
	Spec              CxAgentSpec   `json:"spec"`
	Status            CxAgentStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CxAgentList contains a list of CxAgents
type CxAgentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CxAgent `json:"items"`
}

// Repository type metadata.
var (
	CxAgent_Kind             = "CxAgent"
	CxAgent_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CxAgent_Kind}.String()
	CxAgent_KindAPIVersion   = CxAgent_Kind + "." + CRDGroupVersion.String()
	CxAgent_GroupVersionKind = CRDGroupVersion.WithKind(CxAgent_Kind)
)

func init() {
	SchemeBuilder.Register(&CxAgent{}, &CxAgentList{})
}
