...
type CxIntentObservation struct {
	Name *string `json:"name,omitempty" tf:"name,omitempty"`
}

type CxIntentParameters struct {
...
// CxIntentSpec defines the desired state of CxIntent
type CxIntentSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CxIntentParameters `json:"forProvider"`
}

// CxIntentStatus defines the observed state of CxIntent.
type CxIntentStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CxIntentObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// CxIntent is the Schema for the CxIntents API
...
type CxIntent struct {
	...
	Spec              CxIntentSpec   `json:"spec"`
	Status            CxIntentStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CxIntentList contains a list of CxIntents
type CxIntentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CxIntent `json:"items"`
}

// Repository type metadata.
var (
	CxIntent_Kind             = "CxIntent"
	CxIntent_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CxIntent_Kind}.String()
	CxIntent_KindAPIVersion   = CxIntent_Kind + "." + CRDGroupVersion.String()
	CxIntent_GroupVersionKind = CRDGroupVersion.WithKind(CxIntent_Kind)
)

func init() {
	SchemeBuilder.Register(&CxIntent{}, &CxIntentList{})
}
