...
var (
	CxPage_Kind             = "CxPage"
	CxPage_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CxPage_Kind}.String()
	CxPage_KindAPIVersion   = CxPage_Kind + "." + CRDGroupVersion.String()
	CxPage_GroupVersionKind = CRDGroupVersion.WithKind(CxPage_Kind)
)
