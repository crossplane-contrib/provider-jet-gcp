...
type IPAddressParameters struct {
	...
	// +kubebuilder:validation:Required
	TimeToRetire *string `json:"timeToRetire" tf:"time_to_retire,omitempty"`
...
type ServerCACertParameters struct {
	...
	// +kubebuilder:validation:Required
	CreateTime *string `json:"createTime" tf:"create_time,omitempty"`

	// +kubebuilder:validation:Required
	ExpirationTime *string `json:"expirationTime" tf:"expiration_time,omitempty"`
