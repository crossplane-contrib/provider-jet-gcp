...
func (in *FolderSettingsObservation) DeepCopyInto(out *FolderSettingsObservation) {
	*out = *in
	if in.AncestorHasActiveKeyVersion != nil {
		in, out := &in.AncestorHasActiveKeyVersion, &out.AncestorHasActiveKeyVersion
		*out = new(bool)
		**out = **in
	}
	...
	if in.InvalidKeyVersion != nil {
		in, out := &in.InvalidKeyVersion, &out.InvalidKeyVersion
		*out = new(bool)
		**out = **in
	}
	if in.Name != nil {
