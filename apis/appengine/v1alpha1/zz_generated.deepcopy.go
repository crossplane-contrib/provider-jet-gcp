...
func (in *AutomaticScalingParameters) DeepCopyInto(out *AutomaticScalingParameters) {
	*out = *in
	...
	if in.DiskUtilization != nil {
		...
		*out = make([]DiskUtilizationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.NetworkUtilization != nil {
		...
		*out = make([]NetworkUtilizationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.RequestUtilization != nil {
		...
		*out = make([]RequestUtilizationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DeploymentParameters) DeepCopyInto(out *DeploymentParameters) {
	*out = *in
	if in.CloudBuildOptions != nil {
		...
		*out = make([]CloudBuildOptionsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DomainMappingParameters) DeepCopyInto(out *DomainMappingParameters) {
	*out = *in
	...
	if in.SslSettings != nil {
		...
		*out = make([]SslSettingsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FlexibleAppVersionParameters) DeepCopyInto(out *FlexibleAppVersionParameters) {
	*out = *in
	...
	if in.EndpointsAPIService != nil {
		...
		*out = make([]EndpointsAPIServiceParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.LivenessCheck != nil {
		...
		*out = make([]LivenessCheckParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ReadinessCheck != nil {
		...
		*out = make([]ReadinessCheckParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ServiceSplitTrafficParameters) DeepCopyInto(out *ServiceSplitTrafficParameters) {
	*out = *in
	...
	if in.Split != nil {
		...
		*out = make([]SplitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionAutomaticScalingObservation) DeepCopyInto(out *StandardAppVersionAutomaticScalingObservation) {
	*out = *in
}
...
func (in *StandardAppVersionAutomaticScalingObservation) DeepCopy() *StandardAppVersionAutomaticScalingObservation {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionAutomaticScalingObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionAutomaticScalingParameters) DeepCopyInto(out *StandardAppVersionAutomaticScalingParameters) {
	*out = *in
	if in.MaxConcurrentRequests != nil {
		in, out := &in.MaxConcurrentRequests, &out.MaxConcurrentRequests
		*out = new(int64)
...
func (in *StandardAppVersionAutomaticScalingParameters) DeepCopy() *StandardAppVersionAutomaticScalingParameters {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionAutomaticScalingParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionDeploymentObservation) DeepCopyInto(out *StandardAppVersionDeploymentObservation) {
	*out = *in
}
...
func (in *StandardAppVersionDeploymentObservation) DeepCopy() *StandardAppVersionDeploymentObservation {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionDeploymentObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionDeploymentParameters) DeepCopyInto(out *StandardAppVersionDeploymentParameters) {
	*out = *in
	if in.Files != nil {
		in, out := &in.Files, &out.Files
	...
	if in.Zip != nil {
		in, out := &in.Zip, &out.Zip
		*out = make([]DeploymentZipParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *StandardAppVersionDeploymentParameters) DeepCopy() *StandardAppVersionDeploymentParameters {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionDeploymentParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionEntrypointObservation) DeepCopyInto(out *StandardAppVersionEntrypointObservation) {
	*out = *in
}
...
func (in *StandardAppVersionEntrypointObservation) DeepCopy() *StandardAppVersionEntrypointObservation {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionEntrypointObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionEntrypointParameters) DeepCopyInto(out *StandardAppVersionEntrypointParameters) {
	*out = *in
	if in.Shell != nil {
		in, out := &in.Shell, &out.Shell
		*out = new(string)
...
func (in *StandardAppVersionEntrypointParameters) DeepCopy() *StandardAppVersionEntrypointParameters {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionEntrypointParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionHandlersObservation) DeepCopyInto(out *StandardAppVersionHandlersObservation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StandardAppVersionHandlersObservation.
func (in *StandardAppVersionHandlersObservation) DeepCopy() *StandardAppVersionHandlersObservation {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionHandlersObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionHandlersParameters) DeepCopyInto(out *StandardAppVersionHandlersParameters) {
	*out = *in
	if in.AuthFailAction != nil {
		in, out := &in.AuthFailAction, &out.AuthFailAction
		*out = new(string)
	...
	if in.Script != nil {
		in, out := &in.Script, &out.Script
		*out = make([]HandlersScriptParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.StaticFiles != nil {
		in, out := &in.StaticFiles, &out.StaticFiles
		*out = make([]HandlersStaticFilesParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *StandardAppVersionHandlersParameters) DeepCopy() *StandardAppVersionHandlersParameters {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionHandlersParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionManualScalingObservation) DeepCopyInto(out *StandardAppVersionManualScalingObservation) {
	*out = *in
}
...
func (in *StandardAppVersionManualScalingObservation) DeepCopy() *StandardAppVersionManualScalingObservation {
	...
	out := new(StandardAppVersionManualScalingObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionManualScalingParameters) DeepCopyInto(out *StandardAppVersionManualScalingParameters) {
	*out = *in
	if in.Instances != nil {
		in, out := &in.Instances, &out.Instances
		*out = new(int64)
...
func (in *StandardAppVersionManualScalingParameters) DeepCopy() *StandardAppVersionManualScalingParameters {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionManualScalingParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StandardAppVersionParameters) DeepCopyInto(out *StandardAppVersionParameters) {
	*out = *in
	if in.AutomaticScaling != nil {
		in, out := &in.AutomaticScaling, &out.AutomaticScaling
		*out = make([]StandardAppVersionAutomaticScalingParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Deployment != nil {
		in, out := &in.Deployment, &out.Deployment
		*out = make([]StandardAppVersionDeploymentParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Entrypoint != nil {
		in, out := &in.Entrypoint, &out.Entrypoint
		*out = make([]StandardAppVersionEntrypointParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Handlers != nil {
		in, out := &in.Handlers, &out.Handlers
		*out = make([]StandardAppVersionHandlersParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ManualScaling != nil {
		in, out := &in.ManualScaling, &out.ManualScaling
		*out = make([]StandardAppVersionManualScalingParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.VpcAccessConnector != nil {
		in, out := &in.VpcAccessConnector, &out.VpcAccessConnector
		*out = make([]StandardAppVersionVpcAccessConnectorParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionVpcAccessConnectorObservation) DeepCopyInto(out *StandardAppVersionVpcAccessConnectorObservation) {
	*out = *in
}
...
func (in *StandardAppVersionVpcAccessConnectorObservation) DeepCopy() *StandardAppVersionVpcAccessConnectorObservation {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionVpcAccessConnectorObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardAppVersionVpcAccessConnectorParameters) DeepCopyInto(out *StandardAppVersionVpcAccessConnectorParameters) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
func (in *StandardAppVersionVpcAccessConnectorParameters) DeepCopy() *StandardAppVersionVpcAccessConnectorParameters {
	if in == nil {
		return nil
	}
	out := new(StandardAppVersionVpcAccessConnectorParameters)
	in.DeepCopyInto(out)
	return out
}
