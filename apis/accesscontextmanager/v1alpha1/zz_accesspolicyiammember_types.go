...
type AccessPolicyIAMMemberConditionObservation struct {
}

type AccessPolicyIAMMemberConditionParameters struct {
...
type AccessPolicyIAMMemberParameters struct {
	...
	// +kubebuilder:validation:Optional
	Condition []AccessPolicyIAMMemberConditionParameters `json:"condition,omitempty" tf:"condition,omitempty"`
...
// AccessPolicyIAMMember is the Schema for the AccessPolicyIAMMembers API
