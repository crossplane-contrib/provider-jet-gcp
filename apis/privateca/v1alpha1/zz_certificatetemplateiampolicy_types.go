...
// CertificateTemplateIAMPolicy is the Schema for the CertificateTemplateIAMPolicys API
...
func init() {
	SchemeBuilder.Register(&CertificateTemplateIAMPolicy{}, &CertificateTemplateIAMPolicyList{})
}
