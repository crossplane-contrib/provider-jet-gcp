...
func (tr *OsPolicyAssignment) GetObservation() (map[string]interface{}, error) {
...
func (tr *OsPolicyAssignment) SetObservation(obs map[string]interface{}) error {
...
func (tr *OsPolicyAssignment) GetParameters() (map[string]interface{}, error) {
...
func (tr *OsPolicyAssignment) SetParameters(params map[string]interface{}) error {
