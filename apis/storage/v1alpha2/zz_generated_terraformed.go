...
func (tr *BucketObject) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"content": "spec.forProvider.contentSecretRef", "customer_encryption[*].encryption_key": "spec.forProvider.customerEncryption[*].encryptionKeySecretRef"}
}
