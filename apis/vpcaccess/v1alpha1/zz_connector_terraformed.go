...
func (tr *Connector) GetObservation() (map[string]interface{}, error) {
...
func (tr *Connector) SetObservation(obs map[string]interface{}) error {
...
func (tr *Connector) GetParameters() (map[string]interface{}, error) {
...
func (tr *Connector) SetParameters(params map[string]interface{}) error {
