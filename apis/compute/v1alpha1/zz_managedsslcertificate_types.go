...
var (
	ManagedSSLCertificateKind             = "ManagedSSLCertificate"
	ManagedSSLCertificateGroupKind        = schema.GroupKind{Group: Group, Kind: ManagedSSLCertificateKind}.String()
	ManagedSSLCertificateKindAPIVersion   = ManagedSSLCertificateKind + "." + GroupVersion.String()
	ManagedSSLCertificateGroupVersionKind = GroupVersion.WithKind(ManagedSSLCertificateKind)
)
