...
type BackendServiceCdnPolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	ClientTTL *int64 `json:"clientTtl,omitempty" tf:"client_ttl,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ServeWhileStale *int64 `json:"serveWhileStale,omitempty" tf:"serve_while_stale,omitempty"`
...
type CircuitBreakersParameters struct {
	...
	// +kubebuilder:validation:Optional
	MaxRequestsPerConnection *int64 `json:"maxRequestsPerConnection,omitempty" tf:"max_requests_per_connection,omitempty"`
...
type ConsistentHashParameters struct {
	...
	// Defaults to 1024.
	// +kubebuilder:validation:Optional
	MinimumRingSize *int64 `json:"minimumRingSize,omitempty" tf:"minimum_ring_size,omitempty"`
}
...
type OutlierDetectionParameters struct {
	...
	// Defaults to 5.
	// +kubebuilder:validation:Optional
	ConsecutiveErrors *int64 `json:"consecutiveErrors,omitempty" tf:"consecutive_errors,omitempty"`

	// The number of consecutive gateway failures (502, 503, 504 status or connection
	// errors that are mapped to one of those status codes) before a consecutive
	// gateway failure ejection occurs. Defaults to 5.
	// +kubebuilder:validation:Optional
	ConsecutiveGatewayFailure *int64 `json:"consecutiveGatewayFailure,omitempty" tf:"consecutive_gateway_failure,omitempty"`

	// The percentage chance that a host will be actually ejected when an outlier
	// status is detected through consecutive 5xx. This setting can be used to disable
	// ejection or to ramp it up slowly. Defaults to 100.
	// +kubebuilder:validation:Optional
	EnforcingConsecutiveErrors *int64 `json:"enforcingConsecutiveErrors,omitempty" tf:"enforcing_consecutive_errors,omitempty"`

	// The percentage chance that a host will be actually ejected when an outlier
	// status is detected through consecutive gateway failures. This setting can be
	// used to disable ejection or to ramp it up slowly. Defaults to 0.
	// +kubebuilder:validation:Optional
	EnforcingConsecutiveGatewayFailure *int64 `json:"enforcingConsecutiveGatewayFailure,omitempty" tf:"enforcing_consecutive_gateway_failure,omitempty"`

	// The percentage chance that a host will be actually ejected when an outlier
	// status is detected through success rate statistics. This setting can be used to
	// disable ejection or to ramp it up slowly. Defaults to 100.
	// +kubebuilder:validation:Optional
	EnforcingSuccessRate *int64 `json:"enforcingSuccessRate,omitempty" tf:"enforcing_success_rate,omitempty"`
	...
	// +kubebuilder:validation:Optional
	SuccessRateMinimumHosts *int64 `json:"successRateMinimumHosts,omitempty" tf:"success_rate_minimum_hosts,omitempty"`
	...
	// to 100.
	// +kubebuilder:validation:Optional
	SuccessRateRequestVolume *int64 `json:"successRateRequestVolume,omitempty" tf:"success_rate_request_volume,omitempty"`
	...
	// +kubebuilder:validation:Optional
	SuccessRateStdevFactor *int64 `json:"successRateStdevFactor,omitempty" tf:"success_rate_stdev_factor,omitempty"`
}
