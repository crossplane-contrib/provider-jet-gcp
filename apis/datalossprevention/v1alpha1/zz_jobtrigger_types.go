...
type CloudStorageOptionsParameters struct {
	...
	BytesLimitPerFile *int64 `json:"bytesLimitPerFile,omitempty" tf:"bytes_limit_per_file,omitempty"`

	// Max percentage of bytes to scan from a file. The rest are omitted. The number of bytes scanned is rounded down.
	// Must be between 0 and 100, inclusively. Both 0 and 100 means no limit.
	// +kubebuilder:validation:Optional
	BytesLimitPerFilePercent *int64 `json:"bytesLimitPerFilePercent,omitempty" tf:"bytes_limit_per_file_percent,omitempty"`
	...
	// Must be between 0 and 100, inclusively. Both 0 and 100 means no limit.
	// +kubebuilder:validation:Optional
	FilesLimitPercent *int64 `json:"filesLimitPercent,omitempty" tf:"files_limit_percent,omitempty"`
