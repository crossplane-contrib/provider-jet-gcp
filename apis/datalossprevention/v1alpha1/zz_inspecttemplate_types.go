...
type LikelihoodAdjustmentParameters struct {
	...
	// +kubebuilder:validation:Optional
	RelativeLikelihood *int64 `json:"relativeLikelihood,omitempty" tf:"relative_likelihood,omitempty"`
}
...
type LimitsParameters struct {
	...
	// +kubebuilder:validation:Required
	MaxFindingsPerItem *int64 `json:"maxFindingsPerItem" tf:"max_findings_per_item,omitempty"`

	// Max number of findings that will be returned per request/job. The maximum returned is 2000.
	// +kubebuilder:validation:Required
	MaxFindingsPerRequest *int64 `json:"maxFindingsPerRequest" tf:"max_findings_per_request,omitempty"`
}
...
type MaxFindingsPerInfoTypeParameters struct {
	...
	// +kubebuilder:validation:Required
	MaxFindings *int64 `json:"maxFindings" tf:"max_findings,omitempty"`
}
...
type ProximityParameters struct {
	...
	// +kubebuilder:validation:Optional
	WindowAfter *int64 `json:"windowAfter,omitempty" tf:"window_after,omitempty"`

	// Number of characters before the finding to consider. Either this or window_after must be specified
	// +kubebuilder:validation:Optional
	WindowBefore *int64 `json:"windowBefore,omitempty" tf:"window_before,omitempty"`
}
