...
type ServiceIAMBindingConditionObservation struct {
}

type ServiceIAMBindingConditionParameters struct {
...
type ServiceIAMBindingParameters struct {
	...
	// +kubebuilder:validation:Optional
	Condition []ServiceIAMBindingConditionParameters `json:"condition,omitempty" tf:"condition,omitempty"`
