...
// GetItems of this ServiceConsumersIAMBindingList.
func (l *ServiceConsumersIAMBindingList) GetItems() []resource.Managed {
...
// GetItems of this ServiceConsumersIAMMemberList.
func (l *ServiceConsumersIAMMemberList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this ServiceConsumersIAMPolicyList.
func (l *ServiceConsumersIAMPolicyList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
