...
func (tr *DomainTrust) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"trust_handshake_secret": "spec.forProvider.trustHandshakeSecretSecretRef"}
}
...
// LateInitialize this DomainTrust using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DomainTrust) LateInitialize(attrs []byte) (bool, error) {
	params := &DomainTrustParameters{}
